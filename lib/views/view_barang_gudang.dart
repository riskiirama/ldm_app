...
class ViewBarangGudangPage extends StatefulWidget {
  @override
  State<ViewBarangGudangPage> createState() => _ViewBarangGudangPageState();
}

class _ViewBarangGudangPageState extends State<ViewBarangGudangPage> {
